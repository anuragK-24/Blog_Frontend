...
import "./Footer.scss"
import icon from '../../image/A_Icon.png'
        ...
        <div class="footer-content-column">
          <div class="footer-logo">
            <a class="footer-logo-link" href="#">
              ...
              <img src={icon} style={{height:"4em", width:"4em", marginTop:"-3em"}} alt="" />
            </a>
          </div>
         </div>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Made with love ❤️ JS |By :-  Anurag Kumar </a>
          </p>
        </div>
      </div>
    </footer>
